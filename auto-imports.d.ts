...
declare global {
  ...
  const UserUpdateData: typeof import('./src/api/user.api')['UserUpdateData']
  ...
  const useWebRTC: typeof import('./src/composables/useWebRTC')['useWebRTC']
  ...
  const userApi: typeof import('./src/api/user.api')['userApi']
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly userApi: UnwrapRef<typeof import('./src/api/user.api')['userApi']>
